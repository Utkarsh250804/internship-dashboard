...
# Selection Sort
selection_sorted = selection_sort(strings.copy())
print("Selection Sort Result:", selection_sorted)

# Merge Sort
merge_sorted = merge_sort(strings.copy())
...
# Linear Search
index = linear_search(strings, search_key)
if index != -1:
...
index = binary_search(merge_sorted, search_key)
if index != -1:
